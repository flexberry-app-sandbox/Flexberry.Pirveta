...
namespace IIS.Pirveta
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pirveta.ЕдИзм fЕдИзм;
        
        private double fМасса;
        
        private string fПроиз;
        ...
        public virtual IIS.Pirveta.ЕдИзм ЕдИзм
        {
            get
            {
                ...
                IIS.Pirveta.ЕдИзм result = this.fЕдИзм;
        ...
        /// Произ.
        /// </summary>
        // *** Start programmer edit section *** (Товары.Произ CustomAttributes)

        // *** End programmer edit section *** (Товары.Произ CustomAttributes)
        [StrLen(255)]
        public virtual string Произ
        {
            get
            {
                // *** Start programmer edit section *** (Товары.Произ Get start)

                // *** End programmer edit section *** (Товары.Произ Get start)
                string result = this.fПроиз;
                // *** Start programmer edit section *** (Товары.Произ Get end)

                // *** End programmer edit section *** (Товары.Произ Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Товары.Произ Set start)

                // *** End programmer edit section *** (Товары.Произ Set start)
                this.fПроиз = value;
                // *** Start programmer edit section *** (Товары.Произ Set end)

                // *** End programmer edit section *** (Товары.Произ Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Pirveta.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Pirveta.Товары));
                }
            }
        }
    }
