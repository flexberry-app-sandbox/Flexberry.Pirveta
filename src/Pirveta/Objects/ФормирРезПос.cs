...
namespace IIS.Pirveta
{
    ...
    [View("ФормирРезПосE", new string[] {
            ...
            "ФормирРаспред.НомерДокРаспр as \'Номер док распр\'"}, Hidden=new string[] {
            "ФормирРаспред.НомерДокРаспр"})]
    [MasterViewDefineAttribute("ФормирРезПосE", "ФормирРаспред", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НомерДокРаспр")]
    ...
    public class ФормирРезПос : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pirveta.СтатусЗаказа fСтатусЗаказа;
        
        private bool fНаличиеДеф;
        
        private IIS.Pirveta.УдовлКл fУдовлКл;
        
        private IIS.Pirveta.ФормирРаспред fФормирРаспред;
        ...
        public virtual IIS.Pirveta.СтатусЗаказа СтатусЗаказа
        {
            get
            {
                ...
                IIS.Pirveta.СтатусЗаказа result = this.fСтатусЗаказа;
        ...
        public virtual IIS.Pirveta.УдовлКл УдовлКл
        {
            get
            {
                ...
                IIS.Pirveta.УдовлКл result = this.fУдовлКл;
        ...
        [PropertyStorage(new string[] {
                "ФормирРаспред"})]
        [NotNull()]
        public virtual IIS.Pirveta.ФормирРаспред ФормирРаспред
        {
            get
            {
                ...
                IIS.Pirveta.ФормирРаспред result = this.fФормирРаспред;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосE", typeof(IIS.Pirveta.ФормирРезПос));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормирРезПосL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРезПосL", typeof(IIS.Pirveta.ФормирРезПос));
                }
            }
        }
    }
