...
namespace IIS.Pirveta
{
    ...
    [View("ДокумПоставE", new string[] {
            ...
            "Клиенты.АдресПостав as \'Адрес постав\'"}, Hidden=new string[] {
    ...
    [MasterViewDefineAttribute("ДокумПоставE", "Клиенты", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "АдресПостав")]
    [View("ДокумПоставL", new string[] {
            ...
            "Клиенты.НаимЗаказ",
            "Клиенты.Телефон",
            "Клиенты.АдресПостав as \'Адрес постав\'"})]
    public class ДокумПостав : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pirveta.Организация fОрганизация;
        
        private IIS.Pirveta.Клиенты fКлиенты;
        
        private IIS.Pirveta.DetailArrayOfТЧИнфОЗак fТЧИнфОЗак;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Pirveta.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Pirveta.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Pirveta.Организация Организация
        {
            get
            {
                ...
                IIS.Pirveta.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Pirveta.DetailArrayOfТЧИнфОЗак ТЧИнфОЗак
        {
            get
            {
                ...
                {
                    this.fТЧИнфОЗак = new IIS.Pirveta.DetailArrayOfТЧИнфОЗак(this);
                }
                IIS.Pirveta.DetailArrayOfТЧИнфОЗак result = this.fТЧИнфОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставE", typeof(IIS.Pirveta.ДокумПостав));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставL", typeof(IIS.Pirveta.ДокумПостав));
                }
            }
        }
    }
