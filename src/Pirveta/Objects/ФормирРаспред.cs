...
namespace IIS.Pirveta
{
    ...
    [View("ФормирРаспредE", new string[] {
            ...
            "ДокумПостав.Клиенты",
            "ДокумПостав.Клиенты.НаимЗаказ as \'Наименование заказчика\'",
            "ДокумПостав.Клиенты.АдресПостав as \'Адрес поставки\'",
            "ДокумПостав.Клиенты.Телефон as \'телефон клиента\'",
            "ДокумПостав.Организация as \'организация\'",
            "ДокумПостав.Организация.Наименование as \'организация\'"}, Hidden=new string[] {
    ...
    public class ФормирРаспред : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pirveta.СписокКонтей fСписокКонтей;
        
        private IIS.Pirveta.ДокумПостав fДокумПостав;
        
        private IIS.Pirveta.СписокБарж fСписокБарж;
        
        private IIS.Pirveta.ПунктПогрузки fПунктПогрузки;
        ...
        [PropertyStorage(new string[] {
                "ПунктПогрузки"})]
        [NotNull()]
        public virtual IIS.Pirveta.ПунктПогрузки ПунктПогрузки
        {
            get
            {
                ...
                IIS.Pirveta.ПунктПогрузки result = this.fПунктПогрузки;
        ...
        [PropertyStorage(new string[] {
                "СписокБарж"})]
        [NotNull()]
        public virtual IIS.Pirveta.СписокБарж СписокБарж
        {
            get
            {
                ...
                IIS.Pirveta.СписокБарж result = this.fСписокБарж;
        ...
        [PropertyStorage(new string[] {
                "СписокКонтей"})]
        [NotNull()]
        public virtual IIS.Pirveta.СписокКонтей СписокКонтей
        {
            get
            {
                ...
                IIS.Pirveta.СписокКонтей result = this.fСписокКонтей;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФормирРаспредE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРаспредE", typeof(IIS.Pirveta.ФормирРаспред));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФормирРаспредL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФормирРаспредL", typeof(IIS.Pirveta.ФормирРаспред));
                }
            }
        }
    }
